...
export class TenantFilter extends Filter {
  ...
  public static create(): TenantFilter {
  ...
  public withId(id: ID): this {
    this.data.set(TenantFilter.ID_FILTER, id);
    return this;
  }

  public withTenantId(id: ID): this {
    this.data.set(TenantFilter.TENANT_ID_FILTER, id);
    return this;
  }

  public withEmail(email: Email): this {
    this.data.set(TenantFilter.EMAIL_FILTER, email);
    return this;
  };

  public withRole(roleType: RoleType): this {
    this.data.set(TenantFilter.ROLE_FILTER, roleType);
    return this;
  }

  public isActive(isActive: boolean): this {
    this.data.set(TenantFilter.ACTIVE_FILTER, isActive);
    return this;
  }

  public withPricingName(name: string): this {
    this.data.set(TenantFilter.SUBSCRIPTION_PRICING_NAME_FILTER, name);
    return this;
  }

  public withSubscriptionDuration(duration: number): this {
    this.data.set(TenantFilter.SUBSCRIPTION_DURATION_FILTER, duration);
    return this;
  }

  public withSubscriptionPrice(amount: number): this {
    this.data.set(TenantFilter.SUBSCRIPTION_AMOUNT_FILTER, amount);
    return this;
  }

  public withAllowSendWarnings(allow: boolean) {
    this.data.set(TenantFilter.CONFIG_ALLOW_SEND_WARNINGS_FILTER, allow);
    return this;
  }

  public withAllowSendNotifications(allow: boolean) {
    this.data.set(TenantFilter.CONFIG_ALLOW_SEND_NOTIFICATIONS_FILTER, allow);
    return this;
  }

  public withSubscriptionValidTo(validTo: DateVo) {
    this.data.set(TenantFilter.SUBSCRIPTION_VALID_TO_FILTER, validTo);
    return this;
  }

  public withSubscriptionPaymentOn(paymentDate: DateVo) {
    this.data.set(TenantFilter.SUBSCRIPTION_PAYMENT_DATE_FILTER, paymentDate);
    return this;
  }

  public withSubscriptionActive(isActive: boolean) {
    this.data.set(TenantFilter.SUBSCRIPTION_IS_ACTIVE_FILTER, isActive);
    return this;
  }

  public withSubscriptionExpired(isExpired: boolean) {
    this.data.set(TenantFilter.SUBSCRIPTION_IS_EXPIRED_FILTER, isExpired);
    return this;
  }
